...
from mysite.chou_jiang_mongo import 抽奖主界面表, 抽奖参与者, 采集分工表
from mysite.xiao_shou_mongo import 销售楼宇表
...
if __name__ == '__main__':
    ...
    销售楼宇表objs = 销售楼宇表.objects(手机号列表__contains='13355661100', 小区名称='万科')
    print(销售楼宇表objs)