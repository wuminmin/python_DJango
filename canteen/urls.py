...
urlpatterns = [
    ...
    url(r'^ding_can_xia_zai_mp3/$', views.ding_can_xia_zai_mp3),
    ...
    path('ti_xing_fa_huo',views.ti_xing_fa_huo), #用户提醒发货
    # path('wx_user_commit_order',views.wx_user_commit_order), #用户提交订单
    path('start_voice',views.start_voice), #播放语音
    path('send_goods',views.send_goods), #停止语音
