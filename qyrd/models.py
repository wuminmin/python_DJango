...
# disconnenect()
connect(db=myConfig.db_qyrd, host=myConfig.host, port=myConfig.port,username=myConfig.name_qyrd, password=myConfig.pwd_qyrd)
...
ban_kuai_lan_mu_dict = {
    ...
    '首页图片':['图片新闻'],
    '首页滚动':['滚动图片'],
    '人大概况':['人大简介','组织机构','组成人员','委室职责','换届选举','预决算公开','文件汇编','机关建设'],
    '新闻中心':['人大要闻','通知公告','工作动态'],
    '依法履职':['决定决议','人事任免','监督工作','法律法规'],
    '会议之窗':['人民代表大会会议','常委会会议','主任会议','常委会党组会议','中心组学习','专题教育','代表联系群众','代表邮箱'],
