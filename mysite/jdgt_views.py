...
from mysite.jdgt_mongo import 结对共拓主界面表, 结对共拓用户表, 结对共拓登录状态表, 结对共拓验证码表, 结对共拓客户经理上传单位信息, 结对共拓部门主任客户经理对应表, 结对共拓部门主任走访客户结果表, \
    客户经理未核实, 客户经理已核实, 客户经理不通过, 政企校园完成打分, 党群部审核通过, 党群部审核不通过, 结对共拓部门主任机房巡检结果表, 结对共拓部门主任机房巡检图片表, 巡检机房, 拜访客户, 部门主任存草稿, 草稿箱, \
    核实任务, 录入积分, 审核积分
...
#                 return HttpResponse(自定义登录状态)
#             手机号 = 结对共拓用户表_one.手机号
#             结对共拓食堂模版表_one = 结对共拓食堂模版表.objects(主菜单name=主菜单name, 子菜单page_name=子菜单page_name,
...
#                             晚餐食堂就餐签到 = 没吃
#                             晚餐订餐时间 = 当前时间
#                         结对共拓结果表(手机号=手机号, 主菜单name=主菜单name, 子菜单page_name=子菜单page_name, 子菜单page_desc=子菜单page_desc,
#                             用餐日期=用餐日期, #
...
#                                                         子菜单page_desc=子菜单page_desc, 用餐日期=用餐日期).first()
#                         描述 = '上传成功'
#                         订餐结果描述 = '中餐食堂就餐预订数' + str(结对共拓结果表_first.中餐食堂就餐预订数) + ',晚餐食堂就餐预订数' + str(
#                             结对共拓结果表_first.晚餐食堂就餐预订数) + ',中餐食堂外带预订数' + str(结对共拓结果表_first.中餐食堂外带预订数) + ',晚餐食堂外带预订数' + str(
#                             结对共拓结果表_first.晚餐食堂外带预订数)
...
#                                 return HttpResponse(自定义登录状态)
#                             else:
#                                 结对共拓结果表_one.update(中餐食堂就餐预订数=中餐食堂就餐预订数, 中餐食堂就餐签到=没吃, 中餐订餐时间=当前时间, 中餐取消时间='')
#                         if 晚餐食堂就餐预订数 == 1:
#                             if 结对共拓结果表_one.晚餐食堂就餐预订数 == 1:
#                                 自定义登录状态 = "{\"描述\":\"不能重复订餐\",\"会话\":\"\"}"
#                                 return HttpResponse(自定义登录状态)
#                             else:
#                                 结对共拓结果表_one.update(晚餐食堂就餐预订数=晚餐食堂就餐预订数, 晚餐食堂就餐签到=没吃, 晚餐订餐时间=当前时间, 晚餐取消时间='')
#
#                         结对共拓结果表_first = 结对共拓结果表.objects(手机号=手机号, 主菜单name=主菜单name, 子菜单page_name=子菜单page_name,
#                                                         子菜单page_desc=子菜单page_desc, 用餐日期=用餐日期).first()
#                         描述 = '上传成功'
...
#         自定义登录状态 = {'描述': '下载成功', '会话': '123456', 'list': [], 'app_tittle': '输入有误', 'app_des': '请联系管理员',
...
#                 if 结对共拓结果表_first.中餐食堂就餐签到 == 没吃:
#                     结对共拓结果表_first.update(中餐食堂就餐签到=吃过)
#                     结对共拓核销码表_first.update(核销码=session_key, 手机号=手机号, 二级部门=结对共拓主界面表_first.二级部门, 三级部门=结对共拓主界面表_first.三级部门,
#                                           四级部门=结对共拓主界面表_first.四级部门, 姓名=结对共拓主界面表_first.姓名)
#                     自定义登录状态 = {'描述': '成功', '姓名': 结对共拓主界面表_first.姓名, '当前日期': 当前日期, '类型': '中餐核销'}
#                     自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
#                     自定义登录状态 = str(自定义登录状态)
#                     return HttpResponse(自定义登录状态)
...
#                     return HttpResponse(自定义登录状态)
#                 描述 = '下载成功'
#                 自定义登录状态 = {'描述': 描述, '会话': r_json['session_key'], '主菜单name': 结对共拓结果表_first.主菜单name,
#                            '子菜单page_name': 结对共拓结果表_first.子菜单page_name, '子菜单page_desc': 结对共拓结果表_first.子菜单page_desc,
#                            '姓名': 结对共拓主界面表_first.姓名, '食堂地址': 结对共拓食堂模版表_first.食堂地址, '日期': 日期, '开始日期': 开始日期, '结束日期': 结束日期,
#                            '中餐食堂就餐预订数': 结对共拓结果表_first.中餐食堂就餐预订数, '中餐价格': 结对共拓食堂模版表_first.中餐价格,
#                            '中餐食堂就餐签到': 结对共拓结果表_first.中餐食堂就餐签到, '中餐订餐时间': 结对共拓结果表_first.中餐订餐时间,
#                            '中餐取消时间': 结对共拓结果表_first.中餐取消时间, '晚餐食堂就餐预订数': 结对共拓结果表_first.晚餐食堂就餐预订数,
#                            '晚餐食堂就餐签到': 结对共拓结果表_first.晚餐食堂就餐签到, '晚餐价格': 结对共拓食堂模版表_first.晚餐价格,
#                            '晚餐订餐时间': 结对共拓结果表_first.晚餐订餐时间, '晚餐取消时间': 结对共拓结果表_first.晚餐取消时间}
#                 自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
#                 自定义登录状态 = str(自定义登录状态)
#                 return HttpResponse(自定义登录状态)
#     except:
...
#                 自定义登录状态 = {'描述': 描述, '会话': r_json['session_key'], '主菜单name': 结对共拓结果表_second.主菜单name,
#                            '子菜单page_name': 结对共拓结果表_second.子菜单page_name, '子菜单page_desc': 结对共拓结果表_second.子菜单page_desc,
#                            '姓名': 结对共拓主界面表_first.姓名, '食堂地址': 结对共拓食堂模版表_first.食堂地址, '日期': 日期, '开始日期': 开始日期, '结束日期': 结束日期,
#                            '中餐食堂就餐预订数': 结对共拓结果表_second.中餐食堂就餐预订数, '中餐价格': 结对共拓食堂模版表_first.中餐价格,
#                            '中餐食堂就餐签到': 结对共拓结果表_second.中餐食堂就餐签到, '中餐订餐时间': 结对共拓结果表_second.中餐订餐时间,
#                            '中餐取消时间': 结对共拓结果表_second.中餐取消时间, '晚餐食堂就餐预订数': 结对共拓结果表_second.晚餐食堂就餐预订数,
#                            '晚餐食堂就餐签到': 结对共拓结果表_second.晚餐食堂就餐签到, '晚餐价格': 结对共拓食堂模版表_first.晚餐价格,
#                            '晚餐订餐时间': 结对共拓结果表_second.晚餐订餐时间, '晚餐取消时间': 结对共拓结果表_second.晚餐取消时间}
#                 自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
#                 自定义登录状态 = str(自定义登录状态)
#                 return HttpResponse(自定义登录状态)
#     except:
...
#
#         异步计算菜单(page_name)
#         结对共拓菜单表first = 结对共拓菜单表.objects(食堂名称=page_name).first()
...
#             自定义登录状态 = str(自定义登录状态)
#             return HttpResponse(自定义登录状态)
#         录入分工表first = 结对共拓菜单表.objects(食堂名称=page_name).first()
#         if 录入分工表first == None:
...
#         结对共拓菜单评价表first = 结对共拓菜单评价表.objects(订餐日期=订餐日期, 食堂名称=食堂名称, 订餐类型=订餐类型, 菜谱名称=菜谱名称, ).first()
...
#         r_json = json.loads(r.text)
#         用户 = 结对共拓用户表.objects(openid=r_json['openid']).first()
#         自定义登录状态 = {'ping_jia_list': [{'ping_jia_id': '0', 'biao_ti': '张三', 'nei_rong': '今天中餐还可以，肉好', },
#             {'ping_jia_id': '1', 'biao_ti': '李四', 'nei_rong': '今天晚餐不好，饭不熟', },
#             {'ping_jia_id': '2', 'biao_ti': '王五', 'nei_rong': '黄鱼烧焦了', }, ]}
#         自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
#         自定义登录状态 = str(自定义登录状态)
#         return HttpResponse(自定义登录状态)
#     except:
...
def 客户经理上报单位信息(request):
    try:
        ...
        if 用户 == None:
            ...
            结对共拓客户经理上传单位信息first = 结对共拓客户经理上传单位信息.objects(客户编码=ke_hu_bian_ma).first()
            if 结对共拓客户经理上传单位信息first == None:
                结对共拓客户经理上传单位信息(单位名称=dan_wei_ming_cheng, 客户编码=ke_hu_bian_ma, 客户经理=ke_hu_jing_li,
                    手机号码=shou_ji_hao_ma, ).save()
            else:
                结对共拓客户经理上传单位信息first.update(单位名称=dan_wei_ming_cheng, 客户编码=ke_hu_bian_ma, 客户经理=ke_hu_jing_li,
                    手机号码=shou_ji_hao_ma, )
...
def 部门主任选择客户经理初始化(request):
    try:
        ...
        if 用户 == None:
            ...
            结对共拓部门主任客户经理对应表objs = 结对共拓部门主任客户经理对应表.objects(部门主任手机号码=用户.手机号)
            ...
            page_desc = request.GET['page_desc']
            if page_desc == 巡检机房:
                main_list = [{'main_list_tittle': '第三方设备', 'files': [], 'main_body_tittle': '请输入服务器、路由器、防火墙等型号及年限',
                    'main_body_txt': '', 'main_body_placeholder': '路由器 华为S3200 2004年；防火墙 华为U2000 2006年；', },
                    {'main_list_tittle': '第三方应用平台清单', 'files': [], 'main_body_tittle': '请输入系统名称、开发公司、备注',
                        'main_body_txt': '', 'main_body_placeholder': 'OA办公系统 科大讯飞 2004年；财务管理系统 金蝶软件 2006年；', },
                    {'main_list_tittle': '第三方维保信息', 'files': [], 'main_body_tittle': '请输入维保方式、维保费用',
                        'main_body_txt': '', 'main_body_placeholder': 'OA办公系统 按年收费 每年2万；财务管理系统 按年收费 每年1万；', },
                    {'main_list_tittle': '客户近期软硬件升级需求', 'files': [], 'main_body_tittle': '请输入需求内容和落地时间',
                        'main_body_txt': '', 'main_body_placeholder': '增加采购管理系统 2019年12月', },
                    {'main_list_tittle': '电信设备清单', 'files': [], 'main_body_tittle': '请输至少上传设备、机柜、走线照片各1张',
                        'main_body_txt': '', 'main_body_placeholder': '', },
                    {'main_list_tittle': '安全隐患情况', 'files': [], 'main_body_tittle': '若有安全隐患，请上传照片', 'main_body_txt': '',
                        'main_body_placeholder': '', }, ]
            elif page_desc == 拜访客户:
                main_list = [
                    {'main_list_tittle': '走访主题', 'files': [], 'main_body_tittle': '请输入走访主题', 'main_body_txt': '',
                     'main_body_placeholder': '', },
                    {'main_list_tittle': '走访对象', 'files': [], 'main_body_tittle': '请输入走访对象', 'main_body_txt': '',
                     'main_body_placeholder': '', },
                    {'main_list_tittle': '商机信息', 'files': [], 'main_body_tittle': '请输入商机信息', 'main_body_txt': '',
                     'main_body_placeholder': '', },
                    {'main_list_tittle': '竞争信息', 'files': [], 'main_body_tittle': '请输入竞争信息', 'main_body_txt': '',
                     'main_body_placeholder': '', },
                    {'main_list_tittle': '服务问题', 'files': [], 'main_body_tittle': '请输入服务问题', 'main_body_txt': '',
                     'main_body_placeholder': '', },
                    {'main_list_tittle': '云方案', 'files': [], 'main_body_tittle': '若有云方案请描述，若无则不填', 'main_body_txt': '',
                     'main_body_placeholder': '', }, ]
            else:
                main_list = []
            for 结对共拓部门主任客户经理对应表obj in 结对共拓部门主任客户经理对应表objs:
                姓名 = 结对共拓主界面表.objects(手机号=结对共拓部门主任客户经理对应表obj.客户经理手机号码).first().姓名
                countries.append(姓名)
            结果表 = {'描述': '成功', 'countries': countries, 'countries2': countries2, 'main_list': main_list, }
            结果表 = json.dumps(结果表).encode('utf-8').decode('unicode_escape')
            结果表 = str(结果表)
            return HttpResponse(结果表)
    except:
...
def 部门主任选择单位初始化(request):
    try:
        ...
        if 用户 == None:
            ...
            结对共拓客户经理上传单位信息objs = 结对共拓客户经理上传单位信息.objects(客户经理=countries_val)
            if list(结对共拓客户经理上传单位信息objs) == []:
                自定义登录状态 = {'描述': countries_val + '没有关联客户单位'}
                自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                自定义登录状态 = str(自定义登录状态)
                return HttpResponse(自定义登录状态)
            countries2 = []
            ...
            结果表 = {'描述': '成功', 'countries2': countries2}
            结果表 = json.dumps(结果表).encode('utf-8').decode('unicode_escape')
            结果表 = str(结果表)
            return HttpResponse(结果表)
    except:
...
def 部门主任上传数据(request):
    try:
        ...
        if 用户 == None:
            ...
            当前日期 = time.strftime('%Y-%m-%d', time.localtime(time.time()))
            结对共拓主界面表first = 结对共拓主界面表.objects(手机号=用户.手机号, ).first()
            结对共拓部门主任走访客户结果表first = 结对共拓部门主任走访客户结果表.objects(走访日期=当前日期, 部门主任姓名=结对共拓主界面表first.姓名,
                单位名称=countries2_val).first()
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                结对共拓部门主任走访客户结果表(走访日期=当前日期, 部门主任姓名=结对共拓主界面表first.姓名, 客户经理姓名=countries_val, 单位名称=countries2_val,
                    走访主题=chang_suo_lou_yu_zong_dong_shu, 走访对象={'走访对象': lou_yu_ceng_shu},
                    商机信息={'商机信息': di_xia_shi_ceng_shu}, 竞争信息={'竞争信息': dian_ti_shu_liang}, 服务问题={'服务问题': dx_xia_zai},
                    是否有服务问题=shi_fou_you_di_xia_ting_cha_chang, 是否提交云方案=shi_fou_you_yi_wang_shi_feng,
                    状态=客户经理未核实, ).save()
                描述 = '成功'
            else:
                if 结对共拓部门主任走访客户结果表first.状态 in [客户经理未核实, 客户经理不通过, 党群部审核不通过]:
                    结对共拓部门主任走访客户结果表first.update(走访日期=当前日期, 部门主任姓名=结对共拓主界面表first.姓名, 客户经理姓名=countries_val,
                        单位名称=countries2_val, 走访主题=chang_suo_lou_yu_zong_dong_shu, 走访对象={'走访对象': lou_yu_ceng_shu},
                        商机信息={'商机信息': di_xia_shi_ceng_shu}, 竞争信息={'竞争信息': dian_ti_shu_liang}, 服务问题={'服务问题': dx_xia_zai},
                        是否有服务问题=shi_fou_you_di_xia_ting_cha_chang, 是否提交云方案=shi_fou_you_yi_wang_shi_feng, 状态=客户经理未核实, )
                    描述 = '成功'
                else:
    ...
    try:
        ...
        if 用户 == None:
            ...
            结对共拓部门主任走访客户结果表first = 结对共拓部门主任走访客户结果表.objects(走访日期=当前日期, 部门主任姓名=结对共拓主界面表first.姓名,
                单位名称=countries2_val).first()
            if 结对共拓部门主任走访客户结果表first == None:
                结对共拓部门主任走访客户结果表(走访日期=当前日期, 部门主任姓名=结对共拓主界面表first.姓名, 单位名称=countries2_val, 大门照片=img_file).save()
                描述 = '成功'
            else:
                if 结对共拓部门主任走访客户结果表first.状态 in [客户经理未核实, 客户经理不通过, 党群部审核不通过]:
...
def 客户经理核实走访初始化(request):
    try:
        ...
        if queryset0 == None:
            ...
            list = []
            结对共拓部门主任走访客户结果表objs = 结对共拓部门主任走访客户结果表.objects(状态=客户经理未核实, 客户经理姓名=queryset0.姓名)
            i = 0
            for 结对共拓部门主任走访客户结果表obj in 结对共拓部门主任走访客户结果表objs:
                list.append({'riqi': 结对共拓部门主任走访客户结果表obj.走访日期, 'zhu_ren': 结对共拓部门主任走访客户结果表obj.部门主任姓名,
                    'dan_wei': 结对共拓部门主任走访客户结果表obj.单位名称, 'value': i})
                i = i + 1
            自定义登录状态 = {'描述': '成功', '会话': '', 'list': list}
            自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
            自定义登录状态 = str(自定义登录状态)
            return HttpResponse(自定义登录状态)
    except:
    ...
    try:
        ...
        if 用户 == None:
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                ...
                自定义登录状态 = str(自定义登录状态)
                return HttpResponse(自定义登录状态)
            自定义登录状态 = {'描述': '成功', '会话': '', 'chang_suo_lou_yu_zong_dong_shu': 结对共拓部门主任走访客户结果表first.走访主题,
                'lou_yu_ceng_shu': 结对共拓部门主任走访客户结果表first.走访对象['走访对象'],
                'di_xia_shi_ceng_shu': 结对共拓部门主任走访客户结果表first.商机信息['商机信息'],
                'dian_ti_shu_liang': 结对共拓部门主任走访客户结果表first.竞争信息['竞争信息'], 'dx_xia_zai': 结对共拓部门主任走访客户结果表first.服务问题['服务问题'],
        ...
        if 用户 == None:
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                ...
                if 结对共拓部门主任走访客户结果表first.状态 == 客户经理未核实:
                    结对共拓部门主任走访客户结果表first.update(状态=客户经理已核实)
                    自定义登录状态 = {'描述': '成功', '会话': '', }
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
                elif 结对共拓部门主任走访客户结果表first.状态 == 客户经理已核实:
                    自定义登录状态 = {'描述': '客户经理已核实', '会话': ''}
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
                elif 结对共拓部门主任走访客户结果表first.状态 == 客户经理不通过:
                    自定义登录状态 = {'描述': '客户经理不通过', '会话': ''}
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
                else:
    ...
    try:
        ...
        if 用户 == None:
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                ...
                if 结对共拓部门主任走访客户结果表first.状态 == 客户经理未核实:
                    结对共拓部门主任走访客户结果表first.update(状态=客户经理不通过)
                    自定义登录状态 = {'描述': '成功', '会话': '', }
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
...
def 政企校园录入积分初始化(request):
    try:
        ...
        if 用户 == None:
            ...
            list = []
            结对共拓部门主任走访客户结果表objs = 结对共拓部门主任走访客户结果表.objects(状态=客户经理已核实)
            i = 0
            for 结对共拓部门主任走访客户结果表obj in 结对共拓部门主任走访客户结果表objs:
                list.append({'riqi': 结对共拓部门主任走访客户结果表obj.走访日期, 'zhu_ren': 结对共拓部门主任走访客户结果表obj.部门主任姓名,
                    'dan_wei': 结对共拓部门主任走访客户结果表obj.单位名称, 'value': i})
        ...
        if 用户 == None:
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                ...
                if 结对共拓部门主任走访客户结果表first.状态 == 客户经理未核实:
                    ...
                    当前时间 = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time()))
                    结对共拓部门主任走访客户结果表first.update(状态=政企校园完成打分, 得分={'积分': ji_feng, '当前时间': 当前时间}, )
                    自定义登录状态 = {'描述': '成功', '会话': ''}
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
...
def 党群部审核初始化(request):
    try:
        ...
        if 用户 == None:
            ...
            list = []
            结对共拓部门主任走访客户结果表objs = 结对共拓部门主任走访客户结果表.objects(状态=政企校园完成打分)
            i = 0
            for 结对共拓部门主任走访客户结果表obj in 结对共拓部门主任走访客户结果表objs:
                list.append({'riqi': 结对共拓部门主任走访客户结果表obj.走访日期, 'zhu_ren': 结对共拓部门主任走访客户结果表obj.部门主任姓名,
                    'dan_wei': 结对共拓部门主任走访客户结果表obj.单位名称, 'value': i})
...
def 党群部查询详情(request):
    try:
        ...
        if 用户 == None:
            ...
            zhu_ren = request.GET['zhu_ren']
            dan_wei = request.GET['dan_wei']
            结对共拓部门主任走访客户结果表first = 结对共拓部门主任走访客户结果表.objects(走访日期=riqi, 部门主任姓名=zhu_ren, 单位名称=dan_wei,
                状态=客户经理未核实).first()
            if 结对共拓部门主任走访客户结果表first == None:
                自定义登录状态 = {'描述': '无走访记录' }
                自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                自定义登录状态 = str(自定义登录状态)
                return HttpResponse(自定义登录状态)
            自定义登录状态 = {'描述': '成功', '会话': '', 'ji_feng': 结对共拓部门主任走访客户结果表first.得分['积分'],
        ...
        if 用户 == None:
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                ...
                if 结对共拓部门主任走访客户结果表first.状态 == 客户经理未核实:
                    ...
                    结对共拓部门主任走访客户结果表first.update(状态=党群部审核通过)
                    自定义登录状态 = {'描述': '成功', '会话': ''}
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
        ...
        if 用户 == None:
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                ...
                if 结对共拓部门主任走访客户结果表first.状态 == 客户经理未核实:
                    ...
                    结对共拓部门主任走访客户结果表first.update(状态=党群部审核不通过)
                    自定义登录状态 = {'描述': '成功', '会话': ''}
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
...
def 查询任务初始化(request):
    try:
        ...
        if queryset0 == None:
            ...
            list = []
            # if queryset0.四级部门 == '':
            结对共拓部门主任走访客户结果表objs = 结对共拓部门主任走访客户结果表.objects(部门主任姓名=queryset0.姓名)
            if 结对共拓部门主任走访客户结果表objs == []:
                结对共拓部门主任走访客户结果表objs = 结对共拓部门主任走访客户结果表.objects(客户经理姓名=queryset0.姓名)
                if 结对共拓部门主任走访客户结果表objs == []:
    ...
    try:
        ...
        if 用户 == None:
            ...
            if 结对共拓部门主任走访客户结果表first == None:
                ...
                自定义登录状态 = str(自定义登录状态)
                return HttpResponse(自定义登录状态)
            自定义登录状态 = {'描述': '成功', '会话': '', '状态': 结对共拓部门主任走访客户结果表first.状态, 'ji_feng': 结对共拓部门主任走访客户结果表first.得分['积分'],
                'chang_suo_lou_yu_zong_dong_shu': 结对共拓部门主任走访客户结果表first.走访主题,
                'lou_yu_ceng_shu': 结对共拓部门主任走访客户结果表first.走访对象['走访对象'],
                'di_xia_shi_ceng_shu': 结对共拓部门主任走访客户结果表first.商机信息['商机信息'],
                'dian_ti_shu_liang': 结对共拓部门主任走访客户结果表first.竞争信息['竞争信息'], 'dx_xia_zai': 结对共拓部门主任走访客户结果表first.服务问题['服务问题'],
...
def 部门主任上传机房走访草稿(request):
    try:
        ...
        if 用户 == None:
            ...
            当前日期 = time.strftime('%Y-%m-%d', time.localtime(time.time()))
            单位名称 = request.GET['countries_val']
            客户编码 = request.GET['countries2_val']
            客户经理 = request.GET['countries3_val']
            客户经理手机号码 = request.GET['countries4_val']
            ...
            queryset1 = 结对共拓部门主任机房巡检结果表.objects(
                ...
                客户经理手机号=客户经理手机号码, 客户编码=客户编码,状态=部门主任存草稿,
            ).first()
            if queryset1 == None:
                结对共拓部门主任机房巡检结果表(
                    走访日期=当前日期, 部门主任手机号=用户.手机号,
                    客户经理手机号=客户经理手机号码, 客户编码=客户编码,
                    状态 = 部门主任存草稿,
                    main_list=main_list_list
                ).save()
            else:
                queryset1.update( main_list=main_list_list)
            自定义登录状态 = {'描述': '成功', '会话': '', }
            自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
            自定义登录状态 = str(自定义登录状态)
            return HttpResponse(自定义登录状态)
    ...
    try:
        ...
        if 用户 == None:
            ...
            if queryset1 == None:
                ...
                queryset1.update(状态=客户经理未核实, main_list=main_list_list)
            自定义登录状态 = {'描述': '成功', '会话': '', }
            自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
            自定义登录状态 = str(自定义登录状态)
            return HttpResponse(自定义登录状态)
...
def 部门主任上传机房走访图片(request):
    try:
        ...
        img_file = open(img_file2, 'rb')
        print(file_url)
        queryset0 = 结对共拓部门主任机房巡检图片表.objects(file_url=file_url).first()
        if queryset0 == None:
            结对共拓部门主任机房巡检图片表(file_url=file_url, file_image=img_file).save()
        else:
...
def 部门主任草稿箱机房巡检初始化(request):
    try:
        ...
        if 用户 == None:
            ...
            page_desc = request.GET['page_desc']
            if page_desc == 草稿箱:
                hszf_jfxj_todo = 'xjjf_cgx_todo'
                hszf_jfxj_done = 'xjjf_cgx_done'
                queryset_objs1 = 结对共拓部门主任机房巡检结果表.objects(状态__in=[部门主任存草稿,客户经理不通过])
                queryset_objs2 = 结对共拓部门主任机房巡检结果表.objects(状态__nin=[部门主任存草稿])
            elif page_desc == 核实任务:
                queryset_objs1 = 结对共拓部门主任机房巡检结果表.objects(状态__in=[客户经理未核实])
                queryset_objs2 = 结对共拓部门主任机房巡检结果表.objects(状态__in=[客户经理已核实,政企校园完成打分,党群部审核通过])
                hszf_jfxj_todo = 'hszf_jfxj_todo'
                hszf_jfxj_done = 'xjjf_cgx_done'
            elif page_desc == 录入积分:
                queryset_objs1 = 结对共拓部门主任机房巡检结果表.objects(状态__in=[客户经理已核实,党群部审核不通过])
                queryset_objs2 = 结对共拓部门主任机房巡检结果表.objects(状态__in=[政企校园完成打分,党群部审核通过])
                hszf_jfxj_todo = 'lrjf_jfxj_todo'
                hszf_jfxj_done = 'xjjf_cgx_done'
            elif page_desc == 审核积分:
                queryset_objs1 = 结对共拓部门主任机房巡检结果表.objects(状态__in=[政企校园完成打分])
                queryset_objs2 = 结对共拓部门主任机房巡检结果表.objects(状态__in=[党群部审核通过])
                hszf_jfxj_todo = 'shjf_jfxj_todo'
                hszf_jfxj_done = 'xjjf_cgx_done'
            else:
                queryset_objs1 = 结对共拓部门主任机房巡检结果表.objects(状态='')
                queryset_objs2 = 结对共拓部门主任机房巡检结果表.objects(状态__ne='')
                hszf_jfxj_todo = 'hszf_jfxj_todo'
                hszf_jfxj_done = 'xjjf_cgx_done'
            list = []
            i = 0
                ...
                list.append(
                    {
                        ...
                        'zhu_ren': queryset_obj.部门主任手机号,
                        'dan_wei': queryset_obj.客户编码,
                        'zhu_ren_name': 结对共拓主界面表.objects(手机号=queryset_obj.部门主任手机号).first().姓名,
                        'dan_wei_name': 结对共拓客户经理上传单位信息.objects(客户编码=queryset_obj.客户编码).first().单位名称,
                        'value': i
                    }
                )
                i = i + 1
            ...
            for queryset_obj in queryset_objs2:
                list_done.append({
                    'task_url': hszf_jfxj_done, 'riqi': queryset_obj.走访日期, 'zhu_ren': queryset_obj.部门主任手机号,
                    'zhu_ren_name': 结对共拓主界面表.objects(手机号=queryset_obj.部门主任手机号).first().姓名,
                    'dan_wei_name': 结对共拓客户经理上传单位信息.objects(客户编码=queryset_obj.客户编码).first().单位名称,
                    'dan_wei': queryset_obj.客户编码, 'value': j})
                j = j + 1
            自定义登录状态 = {'描述': '成功', '会话': '', 'list': list, 'list_done': list_done}
            自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
            自定义登录状态 = str(自定义登录状态)
            return HttpResponse(自定义登录状态)
    except:
    ...
    try:
        ...
        if 用户 == None:
            ...
            if page_name == '' and page_desc == '':
                ...
                hszf_jfxj_done = 'hszf_jfxj_done'
            list = []
            queryset_objs1 = 结对共拓部门主任机房巡检结果表.objects(状态=客户经理未核实)
            i = 0
            for queryset_obj in queryset_objs1:
                list.append({'task_url': hszf_jfxj_todo, 'riqi': queryset_obj.走访日期, 'zhu_ren': queryset_obj.部门主任姓名,
                    'dan_wei': queryset_obj.单位名称, 'value': i})
                i = i + 1
            list_done = []
            queryset_objs2 = 结对共拓部门主任机房巡检结果表.objects(状态__ne=客户经理未核实)
            j = 0
            for queryset_obj in queryset_objs2:
                list_done.append({'task_url': hszf_jfxj_done, 'riqi': queryset_obj.走访日期, 'zhu_ren': queryset_obj.部门主任姓名,
                    'dan_wei': queryset_obj.单位名称, 'value': j})
                j = j + 1
            自定义登录状态 = {'描述': '成功', '会话': '', 'list': list, 'list_done': list_done}
            自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
            自定义登录状态 = str(自定义登录状态)
...
def 部门主任草稿箱查询详情(request):
    try:
        ...
        if 用户 == None:
            ...
            zhu_ren = request.GET['zhu_ren']
            dan_wei = request.GET['dan_wei']
            queryset_objs1 = 结对共拓部门主任机房巡检结果表.objects(走访日期=riqi, 部门主任手机号=zhu_ren, 客户编码=dan_wei).first()
            if queryset_objs1 == None:
                main_list = []
                status = '无数据'
            else:
                main_list = queryset_objs1.main_list
                status = '状态:' + queryset_objs1.状态 + '，积分:' + queryset_objs1.得分['积分']
            自定义登录状态 = {'描述': '成功', '会话': '', 'main_list': main_list,'status':status}
            自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
            自定义登录状态 = str(自定义登录状态)
            return HttpResponse(自定义登录状态)
    except:
        print(traceback.format_exc())
        res = {'描述': '系统错误', }
        res = json.dumps(res).encode('utf-8').decode('unicode_escape')
        res = str(res)
        return HttpResponse(res)

def 客户经理核实机房巡检查询详情(request):
    try:
        js_code = request.GET['code']
        url = 'https://api.weixin.qq.com/sns/jscode2session'
        payload = {'appid': jdgt_appid, 'secret': jdgt_secret, 'js_code': js_code, 'grant_type': jdgt_grant_type}
    ...
    try:
        ...
        if 用户 == None:
            ...
            if list(结对共拓部门主任客户经理对应表objs) == []:
                ...
                for 结对共拓部门主任客户经理对应表obj in 结对共拓部门主任客户经理对应表objs:
                    for aaa in 结对共拓客户经理上传单位信息.objects(手机号码=结对共拓部门主任客户经理对应表obj.客户经理手机号码):
                        countries.append(aaa.单位名称)
                        countries2.append(aaa.客户编码)
                        countries3.append(aaa.客户经理)
                        countries4.append(aaa.手机号码)
                page_desc = request.GET['page_desc']
                if page_desc == 巡检机房:
                    main_list = [{'main_list_tittle': '第三方设备', 'files': [], 'main_body_tittle': '请输入服务器、路由器、防火墙等型号及年限',
                        'main_body_txt': '', 'main_body_placeholder': '路由器 华为S3200 2004年；防火墙 华为U2000 2006年；', },
                    ...
                    main_list = []
                结果表 = {'描述': '成功', 'countries': countries, 'countries2': countries2,'countries3':countries3,'countries4':countries4, 'main_list': main_list, }
                结果表 = json.dumps(结果表).encode('utf-8').decode('unicode_escape')
                结果表 = str(结果表)
                return HttpResponse(结果表)
    except:
    ...
    try:
        ...
        if 用户 == None:
            ...
            if queryset0 == None:
                ...
                if queryset0.状态 == 客户经理未核实:
                    queryset0.update(状态=客户经理已核实)
                    自定义登录状态 = {'描述': '成功', '会话': '', }
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
                # elif queryset0.状态 == 客户经理已核实:
                #     自定义登录状态 = {'描述': '客户经理已核实', '会话': ''}
                #     自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                #     自定义登录状态 = str(自定义登录状态)
                #     return HttpResponse(自定义登录状态)
                # elif queryset0.状态 == 客户经理不通过:
                #     自定义登录状态 = {'描述': '客户经理不通过', '会话': ''}
                #     自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                #     自定义登录状态 = str(自定义登录状态)
                #     return HttpResponse(自定义登录状态)
    ...
    try:
        ...
        if 用户 == None:
            ...
            if queryset0 == None:
                ...
                if queryset0.状态 == 客户经理已核实 or  queryset0.状态 == 党群部审核不通过 :
                    ji_feng = request.GET['ji_feng']
                    当前时间 = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time()))
                    queryset0.update(状态=政企校园完成打分, 得分={'积分': ji_feng, '当前时间': 当前时间}, )
                    自定义登录状态 = {'描述': '成功', '会话': ''}
                    自定义登录状态 = json.dumps(自定义登录状态).encode('utf-8').decode('unicode_escape')
                    自定义登录状态 = str(自定义登录状态)
                    return HttpResponse(自定义登录状态)
